...
<table>
<caption><?hh echo ( $MonthDecorator->thisMonth() ); ?></caption>
<?hh
...
?>
<tr>
<td><a href="<?hh echo ($MonthDecorator->prevMonth()); ?>">Prev</a></td>
<td colspan="5">&nbsp;</td>
<td><a href="<?hh echo ($MonthDecorator->nextMonth()); ?>">Next</a></td>
</tr>
</table>
</body>
</html>
